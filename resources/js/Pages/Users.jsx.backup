...
export default function Suppliers({ suppliers }) {
  ...
  // Filter suppliers based on search term - starts with
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-600 text-sm mt-1">Manage your suppliers {searchTerm && `(${filteredSuppliers?.length || 0} results)`}</p>
            </div>
          ...
          <form onSubmit={handleEditSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="Enter supplier name"
              />
              {editErrors.supplier_name && <p className="text-red-600 text-sm mt-1">{editErrors.supplier_name}</p>}
            </div>
